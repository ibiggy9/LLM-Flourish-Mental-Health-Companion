...
export default function GoalPlannerReflection({navigation, route}) {
  const {title, date, goal, q1, a1, q2, a2, q3, a3, q4, a4, q5, a5, plan} = route.params
  ...
  return (
    ...
    <ScrollView> 
        ...
        <Text style={tw`text-white text-xl`}>Goal:</Text>
        <Text style={tw`text-white text-lg`}>{goal}</Text>
        </View>
        ...
        <Text style={tw`text-white text-lg`}>{plan}</Text>
        </View>
